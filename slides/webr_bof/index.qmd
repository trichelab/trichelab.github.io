...
```{webr-r}
webr::install("GEOqeuery", repos=c("https://repo.r-wasm.org/","https://webr.bioconductor.org/3.18"))
library(GEOquery)
...
```{=html}
<iframe width="780" height="300" src="https://microsoft.github.io/datamations/articles/Examples.html" title="Webpage example"></iframe>
```
