...
table1(~ AgeGroup + Sex + Fusion | Protocol, data=MLL)
```
...
## tidytutor {.scrollable}

[tidy data tutor](https://tidydatatutor.com){target="_blank"} is just plain cool
